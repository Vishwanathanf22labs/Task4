...
export default function StepThree({ register, errors }: StepThreeProps) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <label htmlFor="city" className="block text-sm font-semibold text-gray-700 dark:text-gray-200">
          City
        </label>
        <input
          id="city"
      ...
      <div>
        <label htmlFor="zipCode" className="block text-sm font-semibold text-gray-700 dark:text-gray-200">
          ZIP Code
        </label>
        <input
          id="zipCode"
      ...
      <div>
        <label htmlFor="education" className="block text-sm font-semibold text-gray-700 dark:text-gray-200">
          Education Level
        </label>
        <select
          id="education"
      ...
      <div>
        <label htmlFor="experience" className="block text-sm font-semibold text-gray-700 dark:text-gray-200">
          Years of Experience
        </label>
        <input
          id="experience"
      ...
      <div>
        <label htmlFor="aboutYou" className="block text-sm font-semibold text-gray-700 dark:text-gray-200">
          About You
        </label>
        <textarea
          id="aboutYou"
